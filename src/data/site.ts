/**
 * بيانات المؤسسة — حدّث هذا الملف عند توفر المعلومات الحقيقية.
 * الصور تُستبدل من مجلد public/images دون الحاجة لتعديل التصميم.
 */
...
export const company = {
  ...
  /** حدّث رابط الخريطة بعد اعتماد العنوان الرسمي */
  mapEmbedUrl:
